...
const PortfolioForm = () => {
  ...
  // State สำหรับเก็บรูปนักเรียน / ผลงาน
  const [studentImage, setStudentImage] = useState(null);

  const onSubmit = (data) => {
    // เพิ่มข้อมูล student พร้อมรูป
    addStudent({ ...data, studentImage });
    reset();
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} style={{marginBottom: '20px'}}>
      ...
      <div>
        <label>รูปนักเรียน / ผลงาน:</label>
        <FileUpload onFileSelect={setStudentImage} />
      </div>
